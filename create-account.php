    ...
    <div class="max-w-md w-full p-6 bg-white rounded-lg shadow-md">
        ...
        <form method="post" action="create-account.php">
            ...
            <div class="grid grid-cols-2 gap-4">
                <button id="back-btn" onclick="window.location.href='login.php'" class="w-full py-2 px-4 bg-red-500 text-white font-semibold rounded-lg hover:bg-red-600 focus:outline-none focus:bg-red-600">Back</button>
