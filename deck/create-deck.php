        ...
        <h2 class="text-2xl font-semibold text-center py-4">New Deck</h2>
            <div class="p-4">
                <form action="create-deck.php" method="post">
                    <div class="mb-4">
                        <label for="recipient" class="block text-gray-800 font-semibold mb-2">Title</label>
                    ...
                    <div class="mb-4">
                        <label for="message" class="block text-gray-800 font-semibold mb-2">Description</label>
