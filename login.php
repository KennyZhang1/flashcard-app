    ...
    <div class="max-w-md w-full p-6 bg-white rounded-lg shadow-md">
        ...
        <form method="post" action="login.php">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <input id="login-btn" name="login-btn" type="submit" value="Login" class="w-full py-2 px-4 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 focus:outline-none focus:bg-green-600">
            </div>
        </form>
    </div>
</body>
